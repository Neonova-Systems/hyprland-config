...
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd("$zsh \"autoload screenshot-area; screenshot-area\""))
...
-- Workspaces
hl.bind("SUPER + SHIFT + mouse_up", hl.dsp.move({ workspace = "e-1" }))
hl.bind("SUPER + SHIFT + mouse_down", hl.dsp.move({ workspace = "e+1" }))
hl.bind("SUPER + 1", hl.dsp.move({ workspace = "1" }))
hl.bind("SUPER + 2", hl.dsp.move({ workspace = "2" }))
hl.bind("SUPER + 3", hl.dsp.move({ workspace = "3" }))
hl.bind("SUPER + 4", hl.dsp.move({ workspace = "4" }))
hl.bind("SUPER + 5", hl.dsp.move({ workspace = "5" }))
hl.bind("SUPER + 6", hl.dsp.move({ workspace = "6" }))
hl.bind("SUPER + 7", hl.dsp.move({ workspace = "7" }))
hl.bind("SUPER + 8", hl.dsp.move({ workspace = "8" }))
hl.bind("SUPER + 9", hl.dsp.move({ workspace = "9" }))
